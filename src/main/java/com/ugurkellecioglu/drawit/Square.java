...
public class Square extends Shape{
    ...
    public void paint(Graphics g){
        ...
        if(point_two.getX() > point_one.getX() && point_two.getY() > point_one.getY()){
            g.fillRect((int) point_one.getX(), (int) point_one.getY(), (int) WIDTH, (int) HEIGHT);
        }
        else if(point_one.getX()< point_two.getX() && point_one.getY()> point_two.getY()){
            g.fillRect((int) point_one.getX(), (int) point_two.getY(), (int) WIDTH, (int) HEIGHT);
        }
        else if(point_one.getX() > point_two.getX() && point_one.getY() < point_two.getY()){
            g.fillRect((int) point_two.getX(), (int) point_one.getY(), (int) WIDTH, (int) HEIGHT);
        }
        else{
            g.fillRect((int) point_two.getX(), (int) point_two.getY(), (int) WIDTH, (int) HEIGHT);
        }
